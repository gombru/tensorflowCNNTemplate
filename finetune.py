...
def main():
    # Dataset path
    train_list = '/home/imatge/datasets/flickr_style/train.txt'
    test_list = '/home/imatge/datasets/flickr_style/test.txt'
    ...
    with tf.Session() as sess:
        ...
        load_with_skip('models/caffenet.npy', sess, ['fc8']) # Skip weights from fc8
